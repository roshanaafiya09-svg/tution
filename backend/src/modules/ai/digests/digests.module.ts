 ...
 * Assessment (submissions), Parents (consent check), ParentPremiumModule
 * (tier check for "rich digests", blueprint §5/§10 Phase 3), and
 * AiModule (the narrative call), and nothing imports this back.
 * Owns table: digests.
 */
@Module({
  imports: [
