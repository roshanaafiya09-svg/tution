...
import { AcademicCard, TeacherPageHeader, SectionHeader } from '@/components/dashboard';

export default function TeacherFindAnAcademyPage() {
  ...
  return (
    <div>
      <TeacherPageHeader
        eyebrow="Teaching Arrangement"
        title="Find an Academy"
        description="Search academies you might want to teach under. You'll stay an independent teacher either way."
      />
        ...
        {loadError ? (
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {filtered.results.map((academy) => (
              <Link key={academy.academyId} href={`/dashboard/find-an-academy/${academy.slug}`}>
