 ...
 *  'academy_announcement', see studentNotificationHref) — no rail entry
 *  of its own, same as /student/find-a-teacher/:slug. Distinct from the
 *  batch-scoped announcements this portal already lists at
 *  /student/announcements: this reads one academy-wide broadcast by id,
 *  from academy_announcements, not the batch-scoped `announcements`
 *  table. */
  ...
  if (notFound) {
    return (
      <ErrorState
        ...
        onRetry={() => router.push('/student/announcements')}
      />
    );
  }
  ...
  return (
    <div>
      <PageHeader
        ...
        back={{ href: '/student/announcements', label: 'Announcements' }}
      />
