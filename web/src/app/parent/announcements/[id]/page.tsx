 ...
 *  'academy_announcement', see parentNotificationHref) — no rail entry
 *  of its own, same shape as the other SECONDARY_ROUTES in parent-nav.ts. */
