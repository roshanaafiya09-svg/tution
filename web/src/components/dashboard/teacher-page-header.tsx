...
/** The consistent page-level title treatment for every Teacher Dashboard
 *  page that isn't Today (which leads with `TeacherHero` instead) —
 *  mirrors Student's `PageIntro`. Larger and more present than
 *  `SectionHeader`, which is for in-page subsections. */
