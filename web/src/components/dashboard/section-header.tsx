...
/** Section label for the Teacher Dashboard — a small brand-tinted eyebrow
 *  plus a Fraunces title, matching the Student/Parent `SectionHeader`
 *  pattern so every dashboard shares the same editorial rhythm. */
