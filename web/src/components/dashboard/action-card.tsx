...
/** A "needs attention" row with a colored left rail carrying the urgency
 *  signal (error = overdue grading, warning = due soon, info = upcoming
 *  class, brand = a routine action) — mirrors Student's `ActionCard` /
 *  Parent's `AttentionCard`. */
