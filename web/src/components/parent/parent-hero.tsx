...
/** Home's signature moment: the greeting merged into one large panel, with
 *  a dawn-to-dusk gradient rail (amber → indigo) that mirrors the actual
 *  time-of-day tint behind it. The one deliberately bold element on the
 *  page — everything below stays quiet. */
