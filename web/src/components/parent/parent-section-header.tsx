...
/** Section label for the Parent Dashboard — a small brand-tinted eyebrow
 *  plus a Fraunces title, giving every section of Home the same editorial
 *  rhythm instead of a plain `<h2>`. */
