...
/** A compact, elegant contextual empty state for sections inside the Home
 *  command centre and other list pages — a single quiet line instead of a
 *  giant bordered rectangle. Use the shared `EmptyState` instead for a
 *  page's sole/primary content area (e.g. "no children linked yet"). */
