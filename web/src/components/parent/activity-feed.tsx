...
/** A lightweight feed of real events — sourced from the same
 *  `/notifications` feed the bell icon reads, so every row here is a real
 *  thing that happened (a message, a repeated-absence alert), never a
 *  synthesized entry. */
