...
/** A circular progress indicator for a child's attendance/completion rate.
 *  `value` is 0-100, or null for "no data yet" (renders an empty track
 *  only, never a fabricated position). */
