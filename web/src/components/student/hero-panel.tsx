...
/** Overview's signature moment: the greeting and "what do I have today"
 *  content merged into one large panel instead of a header + a separate
 *  card below it. The left rail is a dawn-to-dusk gradient (amber → indigo)
 *  that mirrors the actual time-of-day tint of the panel behind it — the
 *  one deliberately bold element on the page; everything below it stays
 *  quiet. */
