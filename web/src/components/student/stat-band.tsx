 ...
 *  boxes) — the "how am I doing" band on Overview and other stat rows going
 *  forward. Stacks with horizontal dividers on mobile, becomes a row with
 *  vertical dividers from `sm` up. */
