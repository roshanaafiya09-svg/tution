...
/** A node on a vertical timeline rail — a marker (a small dot, by default)
 *  plus a connecting line down to the next node. Used by Schedule to give
 *  a genuinely chronological read instead of a stack of cards. */
