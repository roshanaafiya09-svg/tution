...
/** The Academy Dashboard's page-level title treatment — same shape as
 *  the Student Dashboard's PageIntro/Teacher Dashboard's TeacherPageHeader. */
export function AcademyPageIntro({
  eyebrow,
  title,
  description,
  action,
