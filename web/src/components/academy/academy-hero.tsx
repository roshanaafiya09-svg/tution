...
/** Overview's signature moment — same shape as the Teacher/Student/Parent
 *  dashboards' Hero (TeacherHero/HeroPanel/ParentHero): the greeting merged
 *  into one large panel with a dawn-to-dusk gradient rail (amber → indigo)
 *  mirroring the time-of-day tint behind it, instead of a plain header. */
