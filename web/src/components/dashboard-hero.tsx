...
export type { DayPeriod } from '@/lib/greeting';
...
/** Shared shell for every dashboard's opening moment: the greeting merged
 *  into one large panel, with a dawn-to-dusk gradient rail (amber → indigo)
 *  mirroring the time-of-day tint behind it. Role-specific copy and
 *  contextual content are passed in via props/children — this component
 *  only owns the visual shape shared across Teacher/Student/Parent/Academy. */
