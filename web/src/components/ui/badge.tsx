...
const STATUS_STYLES: Record<string, string> = {
  ...
  upcoming: 'bg-neutral-100 text-neutral-500 dark:bg-neutral-800 dark:text-neutral-400',
  due_today: 'bg-warning-bg text-warning dark:bg-warning/15 dark:text-warning-dark',
  ...
  approved_leave: 'bg-neutral-100 text-neutral-500 dark:bg-neutral-800 dark:text-neutral-400',
